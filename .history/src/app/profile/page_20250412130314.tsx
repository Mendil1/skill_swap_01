          ...
          <div className="grid gap-8 md:grid-cols-3">
                ...
                <CardContent className="pt-6">
                  {offeredSkills.length > 0 ? (
                    ...
                    <div className="text-center py-8 text-slate-500 bg-slate-50 rounded-md">
                      ...
                      <p className="text-sm">Add skills using the form to the right.</p>
                    </div>
                  )}
                </CardContent>
              </Card>
            ...
            <div>
              <Card className="sticky top-4 border-blue-200">
                <CardHeader className="bg-blue-50 border-b border-blue-100">
                  <CardTitle className="text-lg">Add a Skill to Offer</CardTitle>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div>
              <Card className="sticky top-4 border-green-200">
                <CardHeader className="bg-green-50 border-b border-green-100">
                  <CardTitle className="text-lg">Add a Skill to Learn</CardTitle>
                  <CardDescription>What would you like to learn?</CardDescription>
                </CardHeader>
                <CardContent className="pt-6">
                  <SkillForm userId={userProfile?.user_id} defaultType="request" />
                </CardContent>
              </Card>
            </div>
          </div>
