...
export default async function ProfilePage() {
  ...
  const offeredSkills = userSkills?.filter(skill => skill.type === 'offer' || skill.type === 'both') || []
  const requestedSkills = userSkills?.filter(skill => skill.type === 'request' || skill.type === 'both') || []
