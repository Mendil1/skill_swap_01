...
export default async function ProfilePage() {
  ...
  const requestedSkills = (userSkills as unknown as UError: Route "/login" used `searchParams.message`. `searchParams` should be awaited before using its properties.serSkill[] || []).filter(
