        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              Our platform makes it easy to connect with others who want to
            ...
            {[
              {
                ...
                description:
                  "Browse through a variety of skills offered by our community members.",
              },
              {
                icon: "🤝",
                title: "Connect & Exchange",
                description:
                  "Reach out to users and arrange skill exchange sessions.",
              },
              {
                icon: "🚀",
                title: "Grow Together",
                description:
                  "Learn new skills while teaching others what you know best.",
              },
            ].map((step, index) => (
              <div
                key={index}
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              Check out some of the most popular skills being shared in our
              community.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              Hear from people who have used SkillSwap to learn new skills and
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              {
                quote:
                  "SkillSwap helped me learn guitar while teaching Python programming. It's been a win-win experience!",
                name: "David Kim",
                role: "Software Engineer",
              },
              {
                quote:
                  "I've been trying to learn French for years. Through SkillSwap, I found a native speaker who wanted to learn graphic design, which is my specialty.",
                name: "Emma Watson",
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="max-w-2xl mx-auto mb-8">
            Join our community today and start exchanging knowledge with people
