...
export default async function LoginPage({
  ...
  // Extract the message safely from searchParams without direct property access
  let message: string | undefined;
  
  if (searchParams && typeof searchParams.message === 'string') {
    message = searchParams.message;
  } else if (searchParams && Array.isArray(searchParams.message) && searchParams.message.length > 0) {
