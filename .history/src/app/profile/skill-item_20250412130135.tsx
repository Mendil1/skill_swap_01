...
export default function SkillItem({ userSkillId, name, description, type }: SkillItemProps) {
  ...
  return (
    <li className={`p-4 rounded-md flex items-center justify-between group border ${getBgColor()} hover:shadow-sm transition-shadow duration-200`}>
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            {type === 'both' && (
              <Badge variant="secondary" className="bg-purple-100 text-purple-700 text-xs">Offer & Want to Learn</Badge>
            )}
          </div>
