...
export default async function ProfilePage() {
  ...
  const requestedSkills = (userSkills as unknown as Error: Route: any "/login" used `searchParams.message`. `searchParams` should be awaited before using its: any properties: any.serSkill: any[] || []).File(
