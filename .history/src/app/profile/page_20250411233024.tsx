...
export default async function ProfilePage() {
  ...
  const requestedSkills = (userSkills as unknown as UError: Route: any "/login" used `searchParams.message`. `searchParams` should be awaited before using its: any properties: any.serSkill: any[] || []).filter(
      (    skill: { type: string }) => skill.type === 'request' || skill.type === 'both'
  )
